...
namespace Fasr_n_Furious
{
    ...
    public partial class CarsEntities : DbContext
    {
        ...
        public virtual int update_users(Nullable<int> user_id, string username, string email, string password, Nullable<int> role_id)
        {
            var user_idParameter = user_id.HasValue ?
                new ObjectParameter("user_id", user_id) :
                new ObjectParameter("user_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("update_users", user_idParameter, usernameParameter, emailParameter, passwordParameter, role_idParameter);
        }
    }
}
